...
/*
This last check doesn't seem to make sense by default therefore changed
to where rollover occurs twice as it really does and switched pass with
fail to where it makes logical sense.

	System.out.println("Decreasing then increasing counter 3");
    	System.out.println(c3);
		System.out.println(c3.rolledOver());
